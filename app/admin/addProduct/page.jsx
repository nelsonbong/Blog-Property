  ...
  return (
    <>
        <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16'>
            ...
            <input name='projectName' onChange={onChangeHandler} value={data.projectName} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' type="text" placeholder='Type here' required/>
            <p className='text-xl mt-4'>Project Developer</p>
            <input name='developer' onChange={onChangeHandler} value={data.developer} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' type="text" placeholder='Type here' required/>
